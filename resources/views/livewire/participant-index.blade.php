<div class="flex flex-col items-center h-dvh p-0 m-0 space-y-3 lg:space-y-0 lg:items-stretch lg:flex-row">
    ...
    <div class="order-2 w-full mt-3 lg:mt-0 lg:h-full lg:w-[78%] lg:order-1 lg:pr-5">
        <div class="flex flex-col items-center w-full lg:items-end lg:w-9/12 lg:ml-auto">
            <div class="w-11/12 px-3 py-5 bg-white border shadow rounded-xl border-fuchsia-300/50">
